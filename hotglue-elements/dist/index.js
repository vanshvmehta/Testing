...
var Source = function Source(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    src: icon
  })), /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("p", null, label), linked ? /*#__PURE__*/React__default.createElement("div", {
    className: styles['hg-elements-connected'],
    style: styleOverrides.connected
  }, /*#__PURE__*/React__default.createElement("span", null, "Connected"), /*#__PURE__*/React__default.createElement(Done, {
    styleOverrides: styleOverrides
  })) : null), linked && /*#__PURE__*/React__default.createElement("button", {
    onClick: function onClick() {
      return hotglue.link(tenant, flow, tap);
    }
  }, /*#__PURE__*/React__default.createElement(Settings, {
    styleOverrides: styleOverrides
  })));
};
...
var Flow = function Flow(_ref) {
      ...
      if (linkedSources && !type) {
        ...
        var _sources2 = linkedTargets.map(function (_ref3) {
          var icon = _ref3.icon,
              target = _ref3.target,
              label = _ref3.label;
          return /*#__PURE__*/React__default.createElement(Target, {
            key: target,
            linked: isLinked,
            icon: icon,
            label: label,
  ...
  }, /*#__PURE__*/React__default.createElement("h4", null, name, " data"), /*#__PURE__*/React__default.createElement("p", null, description), /*#__PURE__*/React__default.createElement("div", null, sources || /*#__PURE__*/React__default.createElement(Loading, null)));
};
...
var Connections = function Connections(_ref) {
  ...
  if (isLoading || isOpening) {
    ...
    }, loadingComponent || /*#__PURE__*/React__default.createElement(Loading, null));
  }
  ...
  var flowElements = flows.map(function (_flow) {
    ...
    return /*#__PURE__*/React__default.createElement(Flow, {
      name: name,
      description: description,
      tenant: tenant,
      flow: flow,
